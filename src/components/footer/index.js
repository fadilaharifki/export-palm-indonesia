        ...
        <div id="contact" className="flex flex-col md:flex-row  bg-black text-white p-5">
            <div>
                ...
                <div className="flex flex-row mt-3">
                    ...
                    <div className="bg-green-700 p-2 mr-2 rounded-full cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"><a style={{ color: 'white' }} href="https://wa.me/089505822191"><BsWhatsapp size={30} /> </a></div>
